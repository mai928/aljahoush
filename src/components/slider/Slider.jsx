                        ...
                        sliderData.map((slide, index) => (
                            <SwiperSlide key={index} className="swiper-slide relative">
                                ...
                                <div key={index} className='absolute top-7 lg:top-44 start-10 lg:start-28  lg:w-[60%]'>
                                    <h2 className='font-IntoLightTw0 text-xl lg:text-7xl text-white'>{t(slide.title)}</h2>
                                    ...
                                    <div className='mt-10 lg:mt-16 mb-10 text-white  font-Outfit text-[12px] lg:text-[19px]  font-semibold lg:font-bold w-[80%]' dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(t(slide?.details)) }} />
