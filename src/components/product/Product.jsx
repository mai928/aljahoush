    ...
    return (
        <section className='px-10 lg:px-20'>
            ...
            <div className='m-auto text-center my-10 '>
                <Link to={'/products'} className=' bg-primary_color hover:bg-secondary_color hover:text-white  text-xl  px-14 py-4 rounded-full font-Outfit font-semibold '>{t("Show More")}</Link>
