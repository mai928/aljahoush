    ...
    return (
        <section className=' p-3 lg:py-20 lg:px-20 '>
            ...
            <div className="gap-10  block lg:flex lg:flex-row ">
                <div className="lg:w-1/2 mt-0 lg:mt-32">
                    <div className='border-[1px] border-gray-200 rounded-md py-10  ps-5 lg:ps-20 bg-dark_Green'>
                        <h3 className=' text-center lg:text-start text-lg lg:text-5xl font-semibold font-Outfit leading-relaxed text-white'>{t("Contact Information")}</h3>
...
*/}
                ...
                <div className="mt-10 lg:mt-0 lg:w-1/2  text-center">
                    <h3 className="mb-2 lg:text-start text-2xl font-IntoLightTw0 text-secondary_color">{t("Have a Question")}</h3>
